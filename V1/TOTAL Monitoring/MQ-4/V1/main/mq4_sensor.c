...
#define MQ4_DEFAULT_RL_RESISTANCE     20000.0f    /**< 10kΩ load resistance */
...
esp_err_t mq4_init(const mq4_config_t *config)
{
    ...
    g_mq4_state.ro_clean_air = 10000.0f;
...
esp_err_t mq4_read(mq4_reading_t *reading)
{
    ...
    uint32_t raw_adc = adc1_get_raw(g_mq4_state.config.adc_channel);
