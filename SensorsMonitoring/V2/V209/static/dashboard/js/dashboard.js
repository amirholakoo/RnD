...
// Open modal when date inputs are clicked
document.getElementById('date_range_start').addEventListener('click', function() {
    currentDateInput = this;
    openCalendarModal();
});

document.getElementById('date_range_end').addEventListener('click', function() {
    currentDateInput = this;
    openCalendarModal();
});
