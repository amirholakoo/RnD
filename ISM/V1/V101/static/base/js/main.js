        ...
        <div class="Am_alert_  ${classname} ${status}">
            ...
            <div class="d-flex align-items-center ml-4 alert-text-card">
                <div class="icon">
                    ...
                    <svg class="danger" width="30" height="30" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h6 class="alert-text">
                    ${text}
                    ${btns?'<div class="d-flex justify-content-center mt-2 alert_btns"></div>':''}
                </h6>
