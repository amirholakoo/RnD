...
class Shipment(models.Model):
    ...
    location = models.ForeignKey("Warehouse.Warehouse", on_delete=models.PROTECT,related_name="shipment_location",verbose_name="مکان",blank=True, null=True)
    receive_date = models.CharField(max_length=50,verbose_name="تاریخ دریافت",blank=True, null=True)
    weight1_time = models.CharField(max_length=50,verbose_name="زمان وزن 1",blank=True, null=True)
    weight2_time = models.CharField(max_length=50,verbose_name="زمان وزن 2",blank=True, null=True)
    exit_time = models.CharField(max_length=50,verbose_name="زمان خروج",blank=True, null=True)
    ...
    Customer = models.ForeignKey("Customer.Customer", on_delete=models.PROTECT,related_name="shipment_customer",verbose_name="مشتری",blank=True, null=True)
    Supplier = models.ForeignKey("Supplier.Supplier", on_delete=models.PROTECT,related_name="shipment_supplier",verbose_name="تامین کننده",blank=True, null=True)
    weight1 = models.CharField(max_length=10,blank=True, null=True,verbose_name="وزن 1")
    unload_location = models.CharField(max_length=255, blank=True, null=True,verbose_name="مکان خروجی")
    unit = models.ForeignKey("Unit.Unit",on_delete=models.PROTECT,related_name="shipment_unit", blank=True, null=True,verbose_name="واحد")
    quantity = models.CharField(max_length=50,blank=True, null=True,verbose_name="مقدار")
    quality = models.CharField(max_length=255, blank=True, null=True,verbose_name="کیفیت")
    penalty = models.CharField(max_length=255, blank=True, null=True,verbose_name="پیکان")
    weight2 = models.CharField(max_length=10,blank=True, null=True,verbose_name="وزن 2")
    ...
    sales_id = models.CharField(max_length=50,blank=True, null=True)
    ...
    material = models.ForeignKey("Material.Material", on_delete=models.PROTECT,related_name="shipment_material_name",verbose_name="نام ماده",blank=True, null=True)
    
    # purchase_id = models.ForeignKey('Purchases', on_delete=models.SET_NULL, blank=True, null=True)
    vat = models.CharField(max_length=50,blank=True, null=True)
    invoice_status = models.CharField(max_length=255, choices=[('NA', 'NA'), ('Sent', 'Sent'), ('Received', 'Received')], blank=True, null=True)
    payment_status = models.CharField(max_length=255, choices=[('Terms', 'Terms'), ('Paid', 'Paid')], blank=True, null=True)
