        ...
        try:
            ...
            if raw_data:
                ...
                try:
                    ...
                    data_dict["density"] = plc_250_data["d"]
                    data_dict["Diluent"] = plc_250_data["n2"]

                    data_dict["Top_Fan_Pump"] = plc_250_data["vpu"]
                    data_dict["Bottom_Fan_Pump"] = plc_250_data["vpv"]

                    data_dict["Top_PS_In"] = plc_250_data["bti"]
                    data_dict["Top_PS_Out"] = plc_250_data["bto"]
                    data_dict["Top_PS_Re"] = plc_250_data["btr"]
                    data_dict["Bottom_PS_In"] = plc_250_data["bbi"]
                    data_dict["Bottom_PS_Out"] = plc_250_data["bbo"]
                    data_dict["Bottom_PS_Re"] = plc_250_data["bbr"]
