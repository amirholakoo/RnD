...
class PLC(models.Model):
    ...
    LastUpdate = models.DateTimeField(verbose_name="آخرین آپدیت",null=True,blank=True,db_index=True)
...
class KeyAlertConfig(models.Model):
    ...
    color_min_2 = models.CharField(max_length=20,default='#ffaa00',blank=True)
