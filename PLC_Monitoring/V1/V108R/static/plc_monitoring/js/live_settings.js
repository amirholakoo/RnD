...
function updateCardStyle(card, key, value) {
    ...
    if (key === 'st') {
        ...
        if (value === '1') {
            card.style.background = 'rgba(76, 175, 80, 0.2)';
            card.style.borderColor = '#4caf50';
            document.getElementById("machine_status").classList.add("on");
            document.getElementById("machine_status").classList.remove("off");
        } else {
            document.getElementById("machine_status").classList.add("off");
            document.getElementById("machine_status").classList.remove("on");
        }
