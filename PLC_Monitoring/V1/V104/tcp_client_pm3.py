            ...
            if response:
                ...
                if response.startswith("n=") and "=" in response:
                    ...
                    if "ru" in data:
                        ...
                        print("is_running is None____________________________", is_running)
                    ...
                    if roll_obj:
                        ...
                        if "b" in data and data["b"] == "1":
                            ...
                            print("___________________ b _________________", last_break_log, old_break, new_break)
