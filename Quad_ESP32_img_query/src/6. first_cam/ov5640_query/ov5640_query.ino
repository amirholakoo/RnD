...
void setup() {
    ...
    config.xclk_freq_hz = 8000000;       // 20MHz clock frequency
    config.pixel_format = PIXFORMAT_JPEG; // JPEG format for compression
    config.frame_size = FRAMESIZE_FHD;   // 800x600 resolution
    config.jpeg_quality = 4;             // Quality 10 (0-63, lower is higher quality)
